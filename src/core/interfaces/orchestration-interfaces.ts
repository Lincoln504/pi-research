...
export interface IResearchOrchestration extends IService {
  ...
  cleanupResearchServices(sessionId?: string, researchId?: string, ctx?: any, config?: Config, opts?: { skipStoreMaintenance?: boolean }): Promise<void>;
  ...
  checkHealth(round: number, researchId?: string, ctx?: any, signal?: AbortSignal): Promise<void>;
}
