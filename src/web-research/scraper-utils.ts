...
/**
 * Re-exported from the browser error utilities, where it lives beside the three
 * predicates it delegates to. Kept exported here because this is where every scrape
 * caller already imports its error helpers from.
 */
export { isBenignScrapeFailure } from '../infrastructure/browser/browser-error-utils.ts';
