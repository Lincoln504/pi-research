...
vi.mock('../../../src/utils/prompts.ts', () => ({
  loadPrompt: vi.fn(() => 'system prompt {ROOT_QUERY} {MAX_TEAM_SIZE} {QUERY_BUDGET} {COMPLEXITY_LABEL} {COMPLEXITY_GUIDANCE} {{historical_links_section}} {ROUND_NUMBER} {MAX_ROUNDS} {NEXT_ID} {ROUND_PHASE_GUIDANCE} {COMPLEXITY_GUIDANCE} {{previous_queries_section}} {{historical_links_section}}'),
}));
